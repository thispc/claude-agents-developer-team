...
# test harness. With it, this service's conftest is `knowledge.tests.conftest`:
...
# --app-dir services/knowledge`, which puts the directory on sys.path rather
# than importing it as a package, and nothing outside the directory imports in.
