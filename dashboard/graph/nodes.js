...
// the sentence's subject and full stop, not two more modules.
...
export const GLYPH = { aim: "🎯", code: "📦", research: "🔬", data: "🗄", conclusion: "🏁" };
...
function fill(g, n) {
  ...
  inner.append(
    ...
    svgEl("text", { class: "gr-sub", x: -w / 2 + 32, y: 13, "dominant-baseline": "central",
      "pointer-events": "none",
      text: (n.tests && n.tests.total)
        ? `${n.tests.passing}/${n.tests.total} passing${n.tests.failing ? " · advisory" : ""}`
        : n.node_type }),
